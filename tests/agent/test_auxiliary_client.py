...
class TestClaudeAgentSdkAuxiliaryClient:
    ...
    def test_resolves_without_anthropic_http_credentials(self, monkeypatch):
        ...
        assert client.base_url == "claude-agent-sdk://local"
    ...
    def test_turn_external_auto_resolution_reads_configured_runtime(
        ...
        monkeypatch.setattr(
            "agent.auxiliary_client._read_main_api_mode", lambda: "claude_agent_sdk"
        )
    ...
    def test_chat_facade_maps_native_result_and_usage(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "agent.claude_agent_sdk_runtime.run_claude_agent_sdk_auxiliary_completion",
            _complete,
        )
        client = ClaudeAgentSdkAuxiliaryClient("claude-opus-4-6")
    ...
    def test_vision_auto_inherits_main_claude_agent_sdk_transport(self, monkeypatch):
        sentinel = object()
        calls = []
        monkeypatch.setattr(
        ...
        assert calls[0][2]["api_mode"] == "claude_agent_sdk"
