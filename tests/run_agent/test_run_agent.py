...
class TestFallbackAnthropicProvider:
    ...
    def test_fallback_to_subscription_claude_cli_needs_no_http_client(self, agent):
        agent._fallback_activated = False
...
def test_http_loop_hands_prepared_turn_to_claude_cli_fallback(agent, monkeypatch):
    ...
    monkeypatch.setattr("agent.claude_cli_runtime._get_session", get_native)
