...
class TestCreateSession:
    ...
    def test_make_agent_preserves_keychain_claude_runtime(self, monkeypatch):
        captured = {}
        ...
        assert captured["api_mode"] == "claude_cli"
        assert captured["api_key"] == ""
        assert captured["command"] == "/opt/claude"
        assert captured["args"] == ["--debug-to-stderr"]
