...
class TestRunBackgroundTask:
    ...
    @pytest.mark.asyncio
    async def test_claude_agent_sdk_subscription_needs_no_api_key(self):
        ...
        assert MockAgent.call_args.kwargs["api_mode"] == "claude_agent_sdk"
        assert MockAgent.call_args.kwargs["api_key"] == ""
        assert instance._claude_agent_sdk_persistent_binding is False
