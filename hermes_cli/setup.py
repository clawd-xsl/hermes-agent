...
_DEFAULT_PROVIDER_MODELS = {
    ...
    "opencode-go": ["kimi-k3", "kimi-k2.6", "kimi-k2.5", "glm-5.3-flash", "glm-5.1", "glm-5", "mimo-v2.5-pro", "mimo-v2.5", "mimo-v2-pro", "mimo-v2-omni", "minimax-m2.7", "minimax-m2.5", "deepseek-v4-pro", "deepseek-v4-flash", "qwen3.7-max", "qwen3.6-plus", "qwen3.5-plus"],
    "huggingface": [
