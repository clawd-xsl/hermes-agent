    ...
    *,
    ...
    for pid, overlay in HERMES_OVERLAYS.items():
        ...
        if not has_creds and hermes_slug == "anthropic":
            # A configured Claude Agent SDK runtime authenticates inside the child
            ...
            if _claude_agent_sdk_configured:
                has_creds = True
        if not has_creds and hermes_slug == "anthropic":
            try:
        ...
        if hermes_slug == "anthropic" and _claude_agent_sdk_configured:
